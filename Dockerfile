...
# Copy seed database (static stock metadata baked into image for fast bootstrap)
# data/stocks_seed.db is generated by: python3 agent/scripts/export_seed_db.py
# If the file doesn't exist yet, create an empty placeholder so the build succeeds
RUN mkdir -p /app/data
COPY data/stocks_seed.db* /app/data/
