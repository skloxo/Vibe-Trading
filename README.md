...
<h1 align="center">Vibe-Trading：聚焦 A股与港股的量化交易智能体</h1>

<p align="center">
  <b>用多智能体团队协同（Swarm）、回测与券商通道深度赋能投研</b>
</p>
...
<p align="center">
  ...
  <a href="#-key-features">核心功能</a> &nbsp;&middot;&nbsp;
  <a href="#-shadow-account">Shadow Account</a> &nbsp;&middot;&nbsp;
  <a href="#-demo">功能演示</a> &nbsp;&middot;&nbsp;
  <a href="#-quick-start">快速开始</a> &nbsp;&middot;&nbsp;
  <a href="#-examples">典型示例</a> &nbsp;&middot;&nbsp;
...
| **Trading Connectors UI** (s8) | 设置页新增交易通道与券商连接器配置卡片，支持模拟交易、富途、盈透与自定义 MCP 的可视化修改与连接心跳检测 | **开发中 / 下一步** |
| **Typical Use-cases Showcase** (s9) | 重构 Web UI 首页（主欢迎页），全面展示系统技能库、智能体团队协作 and 典型实操量化用例 | **开发中 / 下一步** |
